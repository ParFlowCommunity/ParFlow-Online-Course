...
model.ComputationalGrid.NX = 98
model.ComputationalGrid.NY = 61
...
model.GeomInput.solid_input.FileName = "nanshuihe.pfsol"
...
model.Geom.indi_input.FileName = "subsurface.pfb"
...
model.Geom.domain.ICPressure.FileName = "initial_press.pfb"# restart
...
model.Solver.CLM.MetFilePath = "../../forcing"
...
model.dist("subsurface.pfb")
model.dist("initial_press.pfb") 
